...
const GetStartedContent: FC = () => {
  ...
  return (
    <div className={className}>
      <p className={`${className}_subtitle`}>
        UNLEASHING SOUND IN THE VALLEY DOWNTOWN
      </p>
      <h1 className={`${className}_title`}>Get Started Now!</h1>
      <p className={`${className}_p`}>{paragraph}</p>
      <LinkR className={`${className}_button`} to={routes.join}>
